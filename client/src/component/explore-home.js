                  ...
                  <div className="flex justify-between items-center">
                    <p className="text-[10px] font-semibold">
                      ...
                      {login.email === adminEmail &&
                        <button className="bg-[red] text-black hover:border-black hover:bg-white font-bold border-[1px] rounded-md py-1 px-4 text-[14px]" target="_blank" onClick={() => deletePost(item._id)}>
                          Delete
                        </button>
                      }
                    </p>
